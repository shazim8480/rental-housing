...
const RentalCard: React.FC<RentalCardProps> = ({ property }) => {
  // destructuring necessary property data from props
  const { title, images, pricing, location, contact, additionalDetails } =
    property;
